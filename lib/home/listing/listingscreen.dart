...
class ListingPage extends StatefulWidget {
  final CandData cd;
  const ListingPage(this.cd, {Key? key}) : super(key: key);
          ...
          children: [
            ...
            Expanded(
              child: SingleChildScrollView(
                child: Column(
                    children: List.generate(DummyData.electionPos.length,
                        (index) => positionTile(DummyData.electionPos[index]))),
              ),
            ),
          ],
        ),
        ...
        children: [
          ...
          Wrap(
              ...
              children: List.generate(
                  ...
                  (index) =>
                      positionOwner(data, widget.cd.allCand![index].candName))),
        ],
      ),
    );
  }

  Widget positionOwner(String pos, String name) {
